        ...
        <section className="login-showcase">
          <div className="showcase-stack">
            <div className="showcase-hero">
              ...
              <p>A modern attendance workspace for teams that need dependable time logs, location-aware clock-ins, and a cleaner daily routine.</p>
            </div>

            <div className="showcase-grid">
              <div className="showcase-tile">
                <i className="pi pi-map-marker" />
                <h3>Install the app to your device</h3>
                <InstallPromptBanner />
              </div>
              <div className="showcase-tile">
                <i className="pi pi-map-marker" />
            ...
            <Card className="login-card">
              ...
              <form onSubmit={handleSubmit} className="flex flex-column gap-4">
                <div className="flex flex-column gap-2 input-shell">
                  ...
                  <InputText value={email} onChange={(e) => setEmail(e.target.value)} placeholder="name@company.com" type="email" required className="w-full" />
                </div>

                <div className="flex flex-column gap-2 input-shell">
                  <label className="field-label">Password</label>
                  <Password value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Enter your password" feedback={false} toggleMask required className="w-full" inputClassName="w-full" />
                </div>

                <Button type="submit" label="Sign In" icon="pi pi-arrow-right" loading={loading} className="w-full mt-2 primary-btn" />
              </form>
            </Card>
          </div>
        </section>
